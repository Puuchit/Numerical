...
import { Form, Input, Button, Drawer, Col, Row, Layout } from 'antd';
...
export default class NewtonRaphson extends Component
{
  constructor(props)
    ...
    componentDidMount()
    {
        axios.get('http://localhost:8080/show_New.php')
        // axios.get('http://localhost/Numer/server/show_New.php')//Xampp
        .then(res=>{
  ...
  EquationNewton = () =>{
    ...
    // axios.post('http://localhost/Numer/server/insertdata.php',formData,config)//Xampp
    .then(res=>{
      console.log(res);
    })
    .catch(err=>{
  ...
  showResult=()=>{
    ...
    {
      return <div>
        <h5 style={{fontSize:25}}>This is Result of NewtonRaphson is : {this.state.result}</h5><br/>
        ...
        return (
          ...
          <Head/>
            ...
            />
              ...
              <Drawer
              title="Insert new Equation and Differental"
              width={720}
