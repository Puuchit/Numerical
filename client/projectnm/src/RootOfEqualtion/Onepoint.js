...
export default class OnePoint extends Component
{
  constructor(props)
    ...
    componentDidMount()
    {
        axios.get('http://localhost:8080/show_One.php')
        // axios.get('http://localhost/Numer/server/show_One.php')//Xampp
        .then(res=>{
  ...
  showResult=()=>{
    ...
    {
      return <div>
        <h5 style={{fontSize:25}}>This is Result of One-Point Iteration : {this.state.result}</h5><br/>
