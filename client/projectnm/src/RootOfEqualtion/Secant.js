...
import { Form, Input, Button, Checkbox,Drawer, Col, Row, Layout } from 'antd';
...
export default class Secant extends Component
{
  constructor(props)
    ...
    componentDidMount()
    {
        axios.get('http://localhost:8080/show_Se.php')
  ...
  showResult=()=>{
    ...
    {
      return <div>
        <h5 style={{fontSize:25}}>This is Result of Secant Iteration : {this.state.result}</h5><br/>
  ...
  render() {
    return (
      <div>
        ...
        <br/>
        <div>
          <span style={{fontSize:25}}>X1</span>        
            ...
            <span style={{fontSize:25}}>X2</span>       
